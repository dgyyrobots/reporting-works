      ...
      <el-form class="login-form" :model="formData">
        ...
        <el-form-item prop="scopes">
          <el-checkbox-group v-model="formData.scopes">
            <el-checkbox v-for="scope in queryParams.scopes" :key="scope" :label="scope" style="display: block; margin-bottom: -10px">
              {{ formatScope(scope) }}
            </el-checkbox>
          </el-checkbox-group>
        </el-form-item>
        ...
        <el-form-item class="w-1/1">
          <el-button class="w-6/10" :loading="formLoading" type="primary" @click.prevent="handleAuthorize(true)">
