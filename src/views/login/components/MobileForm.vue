<template>
  ...
  >
    <el-row style="margin-right: -10px; margin-left: -10px">
      ...
      <el-col :span="24" style="padding-right: 10px; padding-left: 10px">
        <el-form-item>
          <XButton class="w-[100%]" :loading="loginLoading" :title="t('login.login')" type="primary" @click="signIn()" />
        </el-form-item>
      </el-col>
      <el-col :span="24" style="padding-right: 10px; padding-left: 10px">
        <el-form-item>
          <XButton class="w-[100%]" :loading="loginLoading" :title="t('login.backLogin')" @click="handleBackLogin()" />
        </el-form-item>
      </el-col>
    </el-row>
  </el-form>
