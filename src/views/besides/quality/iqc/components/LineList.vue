...
const openForm = (type: string, id?: number) => {
  if (!props.iqcId) {
    message.error('请选择一个来料检验')
    return
  }
  formRef.value.open(type, id, props.iqcId)
}
