    ...
    <el-aside width="40%">
      <div class="select-item">
        <div v-for="(news, index) in newsList" :key="index">
          ...
          >
            ...
            <div v-if="newsList.length > 1" class="child">
              ...
              <el-button v-if="isCreating" circle size="small" type="danger" @click="() => removeNews(index)">
                <Icon icon="ep:delete" />
              </el-button>
            </div>
          </div>
          ...
          >
            ...
            <div class="child">
              <el-button v-if="newsList.length > index + 1" circle size="small" type="info" @click="() => moveDownNews(index)">
                <Icon icon="ep:arrow-down-bold" />
              </el-button>
              <el-button v-if="index > 0" circle size="small" type="info" @click="() => moveUpNews(index)">
        ...
        <el-row class="ope-row" justify="center">
          <el-button v-if="newsList.length < 8 && isCreating" circle type="primary" @click="plusNews">
            <Icon icon="ep:plus" />
          </el-button>
        </el-row>
      </div>
    ...
    <el-main>
      <div v-if="newsList.length > 0">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <p>摘要:</p>
            <el-input v-model="activeNewsItem.digest" class="digest" maxlength="120" placeholder="请输入摘要" :rows="8" type="textarea" />
          </el-col>
        </el-row>
        <!--富文本编辑器组件-->
        <el-row>
...
import { createEmptyNewsItem, type NewsItem } from './types'
