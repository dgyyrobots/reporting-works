<template>
  ...
  <!-- 搜索工作栏 -->
  <ContentWrap>
    <el-form class="-mb-15px" :inline="true" label-width="68px" :model="queryParams">
  ...
  <ContentWrap>
    <el-tabs v-model="msgType" @tab-change="onTabChange">
      ...
      <el-tab-pane :name="MsgType.Follow">
        <template #label>
          <el-row align="middle">
            <Icon class="mr-2px" icon="ep:star" />
            关注时回复
          </el-row>
        </template>
      </el-tab-pane>
      <el-tab-pane :name="MsgType.Message">
        <template #label>
          <el-row align="middle">
            <Icon class="mr-2px" icon="ep:chat-line-round" />
            消息回复
          </el-row>
        </template>
      </el-tab-pane>
      <el-tab-pane :name="MsgType.Keyword">
        <template #label>
          <el-row align="middle">
            <Icon class="mr-2px" icon="fa:newspaper-o" />
            关键词回复
          </el-row>
        </template>
      </el-tab-pane>
    ...
    <!-- 列表 -->
    <ReplyTable :list="list" :loading="loading" :msg-type="msgType" @on-delete="onDelete" @on-update="onUpdate" />

    <el-dialog v-model="showDialog" destroy-on-close :title="isCreating ? '新增自动回复' : '修改自动回复'" width="800px">
