<template>
  ...
  <ContentWrap>
    <div v-loading="loading" class="waterfall">
      <div v-for="item in list" v-show="item.content && item.content.newsItem" :key="item.articleId" class="waterfall-item">
        <wx-news :articles="item.content.newsItem" />
        <el-row class="ope-row" justify="center">
          <el-button v-hasPermi="['mp:free-publish:delete']" circle type="danger" @click="handleDelete(item)">
            <Icon icon="ep:delete" />
          </el-button>
        </el-row>
      </div>
