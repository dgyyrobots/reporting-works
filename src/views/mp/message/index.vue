<template>
  <ContentWrap>
    ...
    <el-form ref="queryFormRef" class="-mb-15px" :inline="true" label-width="68px" :model="queryParams">
      ...
      <el-form-item label="用户标识" prop="openid">
        <el-input v-model="queryParams.openid" class="!w-240px" clearable placeholder="请输入用户标识" :v-on="handleQuery" />
      </el-form-item>
  ...
  <!-- 发送消息的弹窗 -->
  <el-dialog v-model="messageBox.show" destroy-on-close title="粉丝消息列表" width="50%" @click="messageBox.show = true">
