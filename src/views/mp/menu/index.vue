  ...
  <ContentWrap>
    <div v-loading="loading" class="clearfix public-account-management">
      ...
      <div class="left">
        ...
        <div class="save_div">
          <el-button v-hasPermi="['mp:menu:save']" class="save_btn" type="success" @click="onSave">保存并发布菜单</el-button>
          <el-button v-hasPermi="['mp:menu:delete']" class="save_btn" type="danger" @click="onClear">清空菜单</el-button>
        </div>
      </div>
      <!--右边配置-->
      <div v-if="showRightPanel" class="right">
        <MenuEditor v-model="activeMenu" :account-id="accountId" :is-parent="isParent" @delete="onDeleteMenu" />
      </div>
...
import { Menu, RawMenu } from './components/types'
