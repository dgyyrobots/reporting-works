...
<template>
  <ContentWrap>
    <div ref="msgDivRef" class="msg-div">
      ...
      <div v-if="!loading">
        <div v-if="hasMore" class="el-table__empty-block" @click="loadMore"><span class="el-table__empty-text">点击加载更多</span></div>
        <div v-if="!hasMore" class="el-table__empty-block"><span class="el-table__empty-text">没有更多了</span></div>
      </div>
