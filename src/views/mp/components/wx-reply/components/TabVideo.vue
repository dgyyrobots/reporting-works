      ...
      <el-col>
        <el-row align="middle" style="text-align: center">
          ...
          <el-col :span="12">
            ...
            <el-dialog v-model="showDialog" append-to-body destroy-on-close title="选择视频" width="90%">
              <WxMaterialSelect :account-id="reply.accountId" type="video" @select-material="selectMaterial" />
            </el-dialog>
          </el-col>
          <!-- 文件上传 -->
          <el-col :span="12">
