      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="等级" prop="level">
            <el-input-number v-model="formData.level" class="!w-240px" :min="0" placeholder="请输入等级" :precision="0" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="升级经验" prop="experience">
            <el-input-number v-model="formData.experience" class="!w-240px" :min="0" placeholder="请输入升级经验" :precision="0" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
