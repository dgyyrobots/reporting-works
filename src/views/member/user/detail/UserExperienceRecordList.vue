<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :show-overflow-tooltip="true" :stripe="true">
      ...
      <el-table-column align="center" :formatter="dateFormatter" label="获得时间" prop="createTime" />
      <el-table-column align="center" label="经验" prop="experience" width="150px">
        <template #default="scope">
          <el-tag v-if="scope.row.experience > 0" class="ml-2" effect="dark" type="success">+{{ scope.row.experience }}</el-tag>
