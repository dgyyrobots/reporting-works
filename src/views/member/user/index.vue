<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :show-overflow-tooltip="true" :stripe="true" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="用户标签" prop="tagNames" :show-overflow-tooltip="false">
        <template #default="scope">
      ...
      <el-table-column align="center" :formatter="dateFormatter" label="登录时间" prop="loginDate" width="180px" />
      <el-table-column align="center" :formatter="dateFormatter" label="注册时间" prop="createTime" width="180px" />
      <el-table-column align="center" fixed="right" label="操作" :show-overflow-tooltip="false" width="100px">
        <template #default="scope">
          <div class="flex items-center justify-center">
            <el-button link type="primary" @click="openDetail(scope.row.id)">详情</el-button>
            <el-dropdown
              v-hasPermi="['member:user:update', 'member:user:update-level', 'member:user:update-point', 'member:user:update-balance']"
            ...
            >
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  ...
                  <el-dropdown-item v-if="checkPermi(['member:user:update-balance'])" command="handleUpdateBlance">
                    修改余额(WIP)
                  </el-dropdown-item>
                </el-dropdown-menu>
              </template>
