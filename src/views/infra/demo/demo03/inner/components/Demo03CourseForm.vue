<template>
  <el-form ref="formRef" v-loading="formLoading" :inline-message="true" label-width="0px" :model="formData" :rules="formRules">
    <el-table class="-mt-10px" :data="formData">
      <el-table-column label="序号" type="index" width="100" />
      <el-table-column label="名字" min-width="150">
        <template #default="{ row, $index }">
          <el-form-item class="mb-0px!" :prop="`${$index}.name`" :rules="formRules.name">
      ...
      <el-table-column label="分数" min-width="150">
        <template #default="{ row, $index }">
          <el-form-item class="mb-0px!" :prop="`${$index}.score`" :rules="formRules.score">
