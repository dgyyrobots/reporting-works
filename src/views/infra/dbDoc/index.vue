<template>
  ...
  <ContentWrap title="数据库文档">
    <div class="mb-10px">
      <el-button plain type="primary" @click="handleExport('HTML')">
        <Icon icon="ep:download" />
        导出 HTML
      </el-button>
      <el-button plain type="primary" @click="handleExport('Word')">
        <Icon icon="ep:download" />
        导出 Word
      </el-button>
      <el-button plain type="primary" @click="handleExport('Markdown')">
        <Icon icon="ep:download" />
        导出 Markdown
      </el-button>
    </div>
