<template>
  <div class="flex">
    ...
    <el-card class="w-1/2" :gutter="12" shadow="always">
      ...
      <el-button block class="ml-2 mt-4" :disabled="!getIsOpen" type="primary" @click="handlerSend">发送</el-button>
    </el-card>
    <!-- 右侧：消息记录 -->
    <el-card class="w-1/2" :gutter="12" shadow="always">
      <template #header>
...
const server = ref(`${`${import.meta.env.VITE_BASE_URL}/infra/ws`.replace('http', 'ws')}?token=${getAccessToken()}`) // WebSocket 服务地址
