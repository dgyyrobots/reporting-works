<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column align="center" label="表描述" prop="tableComment" :show-overflow-tooltip="true" width="200" />
      ...
      <el-table-column align="center" :formatter="dateFormatter" label="更新时间" prop="createTime" width="180" />
