<template>
  <Dialog v-model="dialogVisible" title="导入表" width="800px">
    <!-- 搜索栏 -->
    <el-form ref="queryFormRef" :inline="true" label-width="68px" :model="queryParams">
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column label="表名称" prop="name" :show-overflow-tooltip="true" />
        <el-table-column label="表描述" prop="comment" :show-overflow-tooltip="true" />
      </el-table>
    </el-row>
    <!-- 操作 -->
    <template #footer>
