  ...
  <Dialog v-model="dialogVisible" title="加签" width="500">
    <el-form ref="formRef" v-loading="formLoading" label-width="110px" :model="formData" :rules="formRules">
      <el-form-item label="加签处理人" prop="userIdList">
        <el-select v-model="formData.userIdList" clearable multiple style="width: 100%">
    ...
    <template #footer>
      <el-button :disabled="formLoading" type="primary" @click="submitForm('before')">向前加签</el-button>
      <el-button :disabled="formLoading" type="primary" @click="submitForm('after')">向后加签</el-button>
