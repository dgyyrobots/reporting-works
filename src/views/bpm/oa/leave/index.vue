<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column align="center" :formatter="dateFormatter" label="开始时间" prop="startTime" width="180" />
      ...
      <el-table-column align="center" :formatter="dateFormatter" label="申请时间" prop="createTime" width="180" />
      <el-table-column align="center" label="操作" width="200">
        <template #default="scope">
          ...
          <el-button v-if="scope.row.result === 1" v-hasPermi="['bpm:oa-leave:create']" link type="danger" @click="cancelLeave(scope.row)">
            取消
          </el-button>
        </template>
      </el-table-column>
