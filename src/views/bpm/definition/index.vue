<template>
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column align="center" :formatter="dateFormatter" label="部署时间" prop="deploymentTime" width="180" />
      <el-table-column align="center" label="定义描述" prop="description" show-overflow-tooltip width="300" />
