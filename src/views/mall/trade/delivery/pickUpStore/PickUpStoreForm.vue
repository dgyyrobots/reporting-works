  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle" width="60%">
    <el-form ref="formRef" v-loading="formLoading" label-width="120px" :model="formData" :rules="formRules">
      ...
      <el-form-item label="门店简介" prop="introduction">
        <el-input v-model="formData.introduction" placeholder="请输入门店简介" :rows="3" type="textarea" />
      </el-form-item>
      <el-row>
        <el-col :span="12">
    ...
    <el-dialog v-model="mapDialogVisible" append-to-body class="mapBox" title="获取经纬度" width="500px">
      <iframe id="mapPage" frameborder="0" height="100%" :src="tencentLbsUrl" width="100%"></iframe>
    </el-dialog>
  </Dialog>
</template>
