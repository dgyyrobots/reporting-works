  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle" width="1300px">
    <el-form ref="formRef" v-loading="formLoading" label-width="80px" :model="formData" :rules="formRules">
      ...
      <el-form-item label="运费" prop="charges">
        <el-table border :data="formData.charges" style="width: 100%">
          ...
          <el-table-column align="center" :label="columnTitle.startCountTitle" prop="startCount" width="180">
            <template #default="{ row }">
          ...
          <el-table-column align="center" :label="columnTitle.extraCountTitle" prop="extraCount" width="180">
            <template #default="{ row }">
      ...
      <el-form-item label="包邮区域" prop="frees">
        <el-table border :data="formData.frees" style="width: 100%">
          <el-table-column align="center" label="区域" width="360">
            <template #default="{ row }">
              <el-cascader
                v-model="row.areaIds"
