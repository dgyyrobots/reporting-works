<template>
  <Dialog v-model="dialogVisible" title="订单调价" width="25%">
    <el-form ref="formRef" v-loading="formLoading" label-width="100px" :model="formData">
      <el-form-item label="应付金额(总)">
        <el-input v-model="formData.payPrice" disabled />
      </el-form-item>
      <el-form-item label="订单调价">
        <el-input-number v-model="formData.adjustPrice" class="w-100%" :precision="2" :step="0.1" />
