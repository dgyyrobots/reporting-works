<template>
  <Dialog v-model="dialogVisible" title="修改订单收货地址" width="35%">
    <el-form ref="formRef" v-loading="formLoading" label-width="120px" :model="formData">
      ...
      <el-form-item label="详细地址">
        <el-input v-model="formData.receiverDetailAddress" placeholder="请输入收件人详细地址" :rows="3" type="textarea" />
      </el-form-item>
    </el-form>
    <template #footer>
