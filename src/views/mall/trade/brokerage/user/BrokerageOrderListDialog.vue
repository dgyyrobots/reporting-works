  ...
  <Dialog v-model="dialogVisible" title="推广人列表" width="75%">
    ...
    <ContentWrap>
      <el-table v-loading="loading" :data="list" :show-overflow-tooltip="true" :stripe="true">
        ...
        <el-table-column align="center" :formatter="fenToYuanFormat" label="佣金" min-width="100px" prop="price" />
...
import * as BrokerageRecordApi from '/@/api/mall/trade/brokerage/record/index'
