  ...
  <Dialog v-model="dialogVisible" title="推广人列表" width="75%">
    ...
    <ContentWrap>
      <el-table v-loading="loading" :data="list" :show-overflow-tooltip="true" :stripe="true">
        ...
        <el-table-column align="center" label="推广人数" min-width="80px" prop="brokerageUserCount" />
        ...
        <el-table-column align="center" :formatter="dateFormatter" label="绑定时间" prop="bindUserTime" width="180px" />
      </el-table>
      <!-- 分页 -->
