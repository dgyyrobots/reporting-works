  ...
  <ContentWrap>
    ...
    <el-descriptions title="商品信息">
      <el-descriptions-item label-class-name="no-colon">
        <el-row :gutter="20">
          <el-col :span="15">
            <el-table border :data="[formData.orderItem]">
    ...
    <el-descriptions title="售后日志">
      <el-descriptions-item label-class-name="no-colon">
        <el-timeline>
          <el-timeline-item v-for="saleLog in formData.logs" :key="saleLog.id" placement="top" :timestamp="formatDate(saleLog.createTime)">
            <div class="el-timeline-right-content">
              <span>{{ saleLog.content }}</span>
            </div>
            <template #dot>
              <span class="dot-node-style" :style="{ backgroundColor: getUserTypeColor(saleLog.userType) }">
