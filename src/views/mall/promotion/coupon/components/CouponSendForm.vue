<template>
  <Dialog v-model="dialogVisible" :append-to-body="true" title="发送优惠券" width="70%">
    ...
    <el-table v-loading="loading" :data="list" show-overflow-tooltip>
      ...
      <el-table-column align="center" :formatter="discountFormat" label="优惠金额 / 折扣" min-width="60" prop="discount" />
      <el-table-column align="center" :formatter="usePriceFormat" label="最低消费" min-width="60" prop="usePrice" />
      <el-table-column align="center" :formatter="validityTypeFormat" label="有效期限" min-width="140" prop="validityType" />
      <el-table-column align="center" :formatter="remainedCountFormat" label="剩余数量" min-width="60" />
