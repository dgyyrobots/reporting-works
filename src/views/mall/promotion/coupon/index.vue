<template>
  ...
  <ContentWrap>
    <el-form ref="queryFormRef" class="-mb-15px" :inline="true" label-width="68px" :model="queryParams">
      <el-form-item label="会员昵称" prop="nickname">
        <el-input v-model="queryParams.nickname" class="!w-240px" clearable placeholder="请输入会员昵称" @keyup="handleQuery" />
      </el-form-item>
  ...
  <ContentWrap>
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column align="center" :formatter="dateFormatter" label="领取时间" prop="createTime" width="180" />
      <el-table-column align="center" :formatter="dateFormatter" label="使用时间" prop="useTime" width="180" />
      <el-table-column align="center" class-name="small-padding fixed-width" label="操作">
        <template #default="scope">
          <el-button v-hasPermi="['promotion:coupon:delete']" link type="danger" @click="handleDelete(scope.row.id)">回收</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页 -->
