<template>
  ...
  <!-- 搜索工作栏 -->
  <ContentWrap>
    <el-form ref="queryFormRef" class="-mb-15px" :inline="true" label-width="82px" :model="queryParams">
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column align="center" :formatter="validityTypeFormat" label="使用时间" prop="validityType" width="185" />
      <el-table-column align="center" label="发放数量" prop="totalCount" />
      <el-table-column align="center" :formatter="remainedCountFormat" label="剩余数量" prop="totalCount" />
      <el-table-column align="center" :formatter="takeLimitCountFormat" label="领取上限" prop="takeLimitCount" />
      ...
      <el-table-column align="center" class-name="small-padding fixed-width" fixed="right" label="操作" width="120">
        <template #default="scope">
          ...
          <el-button v-hasPermi="['promotion:coupon-template:delete']" link type="danger" @click="handleDelete(scope.row.id)">
            删除
          </el-button>
        </template>
      </el-table-column>
