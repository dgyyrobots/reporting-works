<template>
  <div class="flex flex-col gap-2 bg-[var(--el-bg-color-overlay)] p-6">
    ...
    <div class="flex flex-row items-baseline justify-between">
      <CountTo class="text-3xl" :decimals="decimals" :end-val="value" :prefix="prefix" />
...
// 计算环比
const percent = computed(() => calculateRelativeRate(props.value as number, props.reference as number))
</script>
