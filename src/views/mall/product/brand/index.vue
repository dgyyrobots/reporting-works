  ...
  <ContentWrap>
    <el-form ref="queryFormRef" class="-mb-15px" :inline="true" label-width="68px" :model="queryParams">
      <el-form-item label="品牌名称" prop="name">
        <el-input v-model="queryParams.name" class="!w-240px" clearable placeholder="请输入品牌名称" @keyup.enter="handleQuery" />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="list" default-expand-all row-key="id">
      ...
      <el-table-column align="center" label="品牌图片" prop="picUrl">
        <template #default="scope">
          <img v-if="scope.row.picUrl" alt="品牌图片" class="h-30px" :src="scope.row.picUrl" />
        </template>
      </el-table-column>
