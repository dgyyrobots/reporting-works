<template>
  <!-- 情况一：添加/修改 -->
  <el-form v-if="!isDetail" ref="productSpuBasicInfoRef" label-width="120px" :model="formData" :rules="rules">
    <el-row>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item label="商品简介" prop="introduction">
          <el-input v-model="formData.introduction" placeholder="请输入商品简介" :rows="3" type="textarea" />
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item label="商品规格" props="specType">
          <el-radio-group v-model="formData.specType" @change="onChangeSpec">
            <el-radio class="radio" :label="false">单规格</el-radio>
      ...
      <el-col :span="12">
        <el-form-item label="分销类型" props="subCommissionType">
          <el-radio-group v-model="formData.subCommissionType" @change="changeSubCommissionType">
            ...
            <el-radio class="radio" :label="true">单独设置</el-radio>
          </el-radio-group>
        </el-form-item>
      </el-col>
      <!-- 多规格添加-->
  ...
  <Descriptions v-if="isDetail" :data="formData" :schema="allSchemas.detailSchema">
    ...
    <template #skus>
      <SkuList ref="skuDetailListRef" :is-detail="isDetail" :prop-form-data="formData" :property-list="propertyList" />
    </template>
  </Descriptions>
...
import { RuleConfig, SkuList, getPropertyList } from '/@/views/mall/product/spu/components/index.ts'
