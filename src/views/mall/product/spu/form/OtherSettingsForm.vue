<template>
  <!-- 情况一：添加/修改 -->
  <el-form v-if="!isDetail" ref="otherSettingsFormRef" label-width="120px" :model="formData" :rules="rules">
    <el-row>
      <el-col :span="24">
        <el-row :gutter="20">
          <el-col :span="8">
      ...
      <el-col :span="24">
        <el-form-item label="活动优先级">
          <ActivityOrdersSort v-model:activity-orders="formData.activityOrders" :promotion-types="promotionTypes" />
        </el-form-item>
      </el-col>
    </el-row>
  </el-form>
