<template>
  <!-- 情况一：添加/修改 -->
  <el-form v-if="!isDetail" ref="descriptionFormRef" label-width="120px" :model="formData" :rules="rules">
    <!--富文本编辑器组件-->
  ...
  <!-- 情况二：详情 -->
  <Descriptions v-if="isDetail" class="descriptionFormDescriptions" :data="formData" :schema="allSchemas.detailSchema">
    <!-- 展示 HTML 内容 -->
