<template>
  <Dialog v-model="dialogVisible" max-height="500px" scroll :title="dialogTitle">
    <el-form ref="formRef" v-loading="formLoading" label-width="160px" :model="formData" :rules="formRules">
      ...
      <el-form-item label="应用图标">
        <upload-img v-model="formData.logo" :limit="1" />
      </el-form-item>
      ...
      <el-form-item label="授权范围" prop="scopes">
        <el-select v-model="formData.scopes" allow-create filterable multiple placeholder="请输入授权范围" style="width: 500px">
