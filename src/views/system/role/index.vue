<template>
  ...
  <!-- 表单弹窗：添加/修改 -->
  <role-form ref="formRef" @success="getList" />
  <!-- 表单弹窗：菜单权限 -->
  <role-assign-menu-form ref="assignMenuFormRef" @success="getList" />
  <!-- 表单弹窗：数据权限 -->
  <role-data-permission-form ref="dataPermissionFormRef" @success="getList" />
</template>
