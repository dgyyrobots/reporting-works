  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    <el-form ref="formRef" v-loading="formLoading" label-width="100px" :model="formData" :rules="formRules">
      ...
      <el-form-item v-if="formData.type !== 3" label="菜单图标">
        <icon-select v-model="formData.icon" clearable />
        <!-- <el-button type="warn" size="medium" @click="console.log(formData)">1</el-button> -->
      </el-form-item>
      ...
      <el-form-item label="显示排序" prop="sort">
        <el-input-number v-model="formData.sort" clearable controls-position="right" :min="0" />
      </el-form-item>
      ...
      <el-form-item v-if="formData.type !== 3" label="显示状态" prop="visible">
        ...
        <el-radio-group v-model="formData.visible">
          <el-radio key="true" border :label="true">显示</el-radio>
          <el-radio key="false" border :label="false">隐藏</el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item v-if="formData.type !== 3" label="总是显示" prop="alwaysShow">
        ...
        <el-radio-group v-model="formData.alwaysShow">
          <el-radio key="true" border :label="true">总是</el-radio>
          <el-radio key="false" border :label="false">不是</el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item v-if="formData.type === 2" label="缓存状态" prop="keepAlive">
        ...
        <el-radio-group v-model="formData.keepAlive">
          <el-radio key="true" border :label="true">缓存</el-radio>
          <el-radio key="false" border :label="false">不缓存</el-radio>
        </el-radio-group>
      </el-form-item>
    </el-form>
    <template #footer>
