<template>
  ...
  <content-wrap>
    <!-- 搜索工作栏 -->
    <el-form ref="queryFormRef" class="-mb-15px" :inline="true" label-width="130px" :model="queryParams">
      ...
      <el-form-item label="社交平台" prop="socialType">
        <el-select v-model="queryParams.socialType" class="!w-240px" clearable placeholder="请选择社交平台">
          <el-option
      ...
      <el-form-item>
        ...
        <el-button v-hasPermi="['system:social-client:create']" plain type="primary" @click="openForm('create')">
  ...
  <content-wrap>
    <el-table v-loading="loading" :data="list" :show-overflow-tooltip="true" :stripe="true">
      ...
      <el-table-column align="center" label="操作">
        <template #default="scope">
          <el-button v-hasPermi="['system:social-client:update']" link type="primary" @click="openForm('update', scope.row.id)">
            编辑
          </el-button>
          <el-button v-hasPermi="['system:social-client:delete']" link type="danger" @click="handleDelete(scope.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页 -->
  ...
  <!-- 表单弹窗：添加/修改 -->
  <social-client-form ref="formRef" @success="getList" />
</template>
