<template>
  <ContentWrap>
    ...
    <el-form ref="queryFormRef" class="-mb-15px" :inline="true" label-width="68px" :model="queryParams">
      <el-form-item label="线索名称" prop="name">
        <el-input v-model="queryParams.name" class="!w-240px" clearable placeholder="请输入线索名称" @keyup.enter="handleQuery" />
      </el-form-item>
      ...
      <el-form-item>
        ...
        <el-button v-hasPermi="['crm:clue:export']" :loading="exportLoading" plain type="success" @click="handleExport">
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :show-overflow-tooltip="true" :stripe="true">
      ...
      <el-table-column align="center" label="转化状态" prop="transformStatus">
      ...
      <el-table-column align="center" label="线索名称" prop="name" />
      <el-table-column align="center" label="客户id" prop="customerId" />
      <el-table-column align="center" :formatter="dateFormatter" label="下次联系时间" prop="contactNextTime" width="180px" />
      ...
      <el-table-column align="center" fixed="right" label="操作" min-width="110">
        <template #default="scope">
          <el-button v-hasPermi="['crm:clue:update']" link type="primary" @click="openForm('update', scope.row.id)">编辑</el-button>
          <el-button v-hasPermi="['crm:clue:delete']" link type="danger" @click="handleDelete(scope.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页 -->
