      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item label="负责人" prop="ownerUserId">
            <el-select v-model="formData.ownerUserId" lable-key="nickname" placeholder="请选择负责人" value-key="id">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="客户名称" prop="customerName">
            <el-select v-model="formData.customerId" lable-key="name" placeholder="请选择客户" value-key="id">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="手机号" prop="mobile">
            <el-input v-model="formData.mobile" input-style="width:190px;" placeholder="请输入手机号" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="邮箱" prop="email">
            <el-input v-model="formData.email" input-style="width:190px;" placeholder="请输入邮箱" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="微信" prop="wechat">
            <el-input v-model="formData.wechat" input-style="width:190px;" placeholder="请输入微信" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="地址" prop="address">
            <el-input v-model="formData.address" input-style="width:190px;" placeholder="请输入地址" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
