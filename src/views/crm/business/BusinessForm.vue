  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    <el-form ref="formRef" v-loading="formLoading" label-width="100px" :model="formData" :rules="formRules">
      ...
      <el-form-item label="客户名称" prop="customerName">
        <el-popover :offset="10" placement="bottom" :teleported="false" trigger="click" :visible="showCustomer" :width="600">
          <template #reference>
            <el-input v-model="formData.customerName" placeholder="请选择客户" @click="openCustomerSelect" />
          </template>
          <el-table ref="multipleTableRef" :data="customerList" @select="handleSelectionChange">
            <el-table-column label="选择" type="selection" width="55" />
            <el-table-column label="编号" property="id" width="100" />
            <el-table-column label="客户名称" property="name" width="150" />
      ...
      <el-form-item label="商机状态" prop="statusId">
        <el-select v-model="formData.statusId" clearable placeholder="请选择商机状态" size="small">
      ...
      <el-form-item label="预计成交日期" prop="dealTime">
        <el-date-picker v-model="formData.dealTime" placeholder="选择预计成交日期" type="date" value-format="x" />
      </el-form-item>
...
const handleSelectionChange = (_, row: any) => {
