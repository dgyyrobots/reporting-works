  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    <el-form ref="formRef" v-loading="formLoading" label-width="100px" :model="formData" :rules="formRules">
      ...
      <el-form-item label="状态设置" prop="statusList">
        <el-table border :data="formData.statusList" style="width: 100%">
          <el-table-column align="center" label="状态" prop="star" width="120">
            <template #default="scope">
              <el-text>状态{{ scope.$index + 1 }}</el-text>
            </template>
          </el-table-column>
          <el-table-column align="center" label="状态名称" prop="name" width="120">
            <template #default="{ row }">
              <el-input v-model="row.name" placeholder="请输入状态名称" />
            </template>
          </el-table-column>
          <el-table-column align="center" label="赢单率" prop="percent" width="120">
            <template #default="{ row }">
          ...
          <el-table-column align="center" label="操作">
            <template #default="scope">
              ...
              <el-button v-show="scope.$index > 0" link type="danger" @click="deleteStatusArea(scope.$index)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-form-item>
