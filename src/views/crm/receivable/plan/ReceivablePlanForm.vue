  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    <el-form ref="formRef" v-loading="formLoading" label-width="100px" :model="formData" :rules="formRules">
      ...
      <el-form-item label="计划回款日期" prop="returnTime">
        <el-date-picker v-model="formData.returnTime" placeholder="选择计划回款日期" type="date" value-format="x" />
      </el-form-item>
      ...
      <el-form-item label="提醒日期" prop="remindTime">
        <el-date-picker v-model="formData.remindTime" placeholder="选择提醒日期" type="date" value-format="x" />
      </el-form-item>
