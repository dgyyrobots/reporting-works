<template>
  <div>
    <Dialog v-model="dialogVisible" :title="dialogTitle" width="830px" @closed="close">
      <el-form ref="formRef" v-loading="formLoading" :form-rules="formRules" label-width="100px" :model="formData">
        ...
        <div v-if="formData.config.mode === 2">
          ...
          <el-form-item label="支付宝公钥证书" label-width="180px" prop="config.alipayPublicCertContent">
            <el-input
