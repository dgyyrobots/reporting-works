<template>
  <Dialog v-model="dialogVisible" title="发起转账" width="800px">
    <el-card style="margin-top: 10px">
      <el-descriptions border :column="2" title="转账信息">
        <el-descriptions-item label="转账类型">
          {{ typeName }}
        </el-descriptions-item>
        <el-descriptions-item label="转账金额(元)">￥{{ (transfer.price / 100.0).toFixed(2) }}</el-descriptions-item>
    ...
    <el-card style="margin-top: 20px">
      ...
      <div>
        <el-radio-group v-model="channelCode">
          <el-radio :disabled="transfer.type === 2 || transfer.type === 3 || transfer.type === 4" label="alipay_pc">
            <img :src="svg_alipay_app" />
          </el-radio>
          <el-radio :disabled="transfer.type === 1 || transfer.type === 3 || transfer.type === 4" label="wx_app">
            <img :src="svg_wx_app" />
          </el-radio>
        </el-radio-group>
      </div>
...
const transfer = reactive<PayTransferApi.TransferNullableVO>({
  appId: undefined,
