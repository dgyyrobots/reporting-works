  ...
  <Dialog v-model="dialogVisible" title="详情" width="700px">
    <el-descriptions :column="2" label-class-name="desc-label">
      ...
      <el-descriptions-item label="渠道退款单号">
        <el-tag v-if="refundDetail.channelRefundNo" size="small" type="success">{{ refundDetail.channelRefundNo }}</el-tag>
      </el-descriptions-item>
      ...
      <el-descriptions-item label="支付金额">
        <el-tag size="small" type="success">￥{{ (refundDetail.payPrice / 100.0).toFixed(2) }}</el-tag>
      </el-descriptions-item>
