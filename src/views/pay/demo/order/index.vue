<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column align="center" :formatter="dateFormatter" label="支付时间" prop="payTime" width="180" />
      ...
      <el-table-column align="center" class-name="small-padding fixed-width" label="操作">
        <template #default="scope">
          <el-button v-if="!scope.row.payStatus" link type="primary" @click="handlePay(scope.row)">前往支付</el-button>
          <el-button v-if="scope.row.payStatus && !scope.row.payRefundId" link type="danger" @click="handleRefund(scope.row)">
            发起退款
          </el-button>
        </template>
      </el-table-column>
  ...
  <Dialog v-model="dialogVisible" title="发起订单" width="500px">
    <el-form ref="formRef" v-loading="formLoading" label-width="80px" :model="formData" :rules="formRules">
      <el-form-item label="商品" prop="spuId">
        <el-select v-model="formData.spuId" clearable placeholder="请输入下单商品" style="width: 380px">
