  ...
  <div class="process-panel__container" :style="{ width: `${width}px` }">
    <el-collapse v-model="activeTab">
      <el-collapse-item name="base">
        ...
        <element-base-info :business-object="elementBusinessObject" :id-edit-disabled="idEditDisabled" :model="model" :type="elementType" />
      </el-collapse-item>
      ...
      <el-collapse-item v-if="formVisible" key="form" name="condition">
        ...
        友情提示：使用
        <router-link :to="{ path: '/bpm/manager/form' }"><el-link type="danger">流程表单</el-link></router-link>
        替代，提供更好的表单设计功能
      </el-collapse-item>
