  ...
  <div class="panel-tab__content">
    <el-form label-width="90px" :model="needProps" :rules="rules">
      <div v-if="needProps.type == 'bpmn:Process'">
        ...
        <el-link href="https://doc.iocoder.cn/bpm/#_3-%E6%B5%81%E7%A8%8B%E5%9B%BE%E7%A4%BA%E4%BE%8B" target="_blank" type="danger">
          如何实现实现会签、或签？
        </el-link>
        ...
        <el-form-item label="流程名称" prop="name">
          <el-input v-model="needProps.name" clearable placeholder="请输入流程名称" @change="handleNameUpdate" />
        </el-form-item>
      </div>
      <div v-else>
