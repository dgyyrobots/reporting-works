<template>
  <div class="panel-tab__content">
    <el-form label-width="90px" :model="flowConditionForm" size="small">
      ...
      <el-form-item v-if="flowConditionForm.conditionType && flowConditionForm.conditionType === 'expression'" key="express" label="表达式">
        <el-input v-model="flowConditionForm.body" clearable style="width: 192px" @change="updateFlowCondition" />
      </el-form-item>
      <template v-if="flowConditionForm.conditionType && flowConditionForm.conditionType === 'script'">
        ...
        <el-form-item v-if="flowConditionForm.scriptType === 'inlineScript'" key="body" label="脚本">
          <el-input v-model="flowConditionForm.body" clearable type="textarea" @change="updateFlowCondition" />
        </el-form-item>
