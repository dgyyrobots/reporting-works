<template>
  <div class="panel-tab__content">
    <el-table border :data="elementPropertyList" fit max-height="240">
    ...
    <div class="element-drawer__button">
      <x-button pre-icon="ep:plus" title="添加属性" type="primary" @click="openAttributesForm(null, -1)" />
    </div>

    <el-dialog v-model="propertyFormModelVisible" append-to-body destroy-on-close title="属性配置" width="600px">
      <el-form ref="attributeFormRef" label-width="80px" :model="propertyForm">
