<template>
  <div class="panel-tab__content">
    <el-table border :data="elementListenersList" size="small">
      ...
      <el-table-column label="操作" width="100px">
        <template #default="scope">
          ...
          <el-button link size="small" style="color: #ff4d4f" @click="removeListener(scope.$index)">移除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <div class="element-drawer__button">
      <x-button pre-icon="ep:plus" title="添加监听器" type="primary" @click="openListenerForm(null)" />
    </div>

    <!-- 监听器 编辑/创建 部分 -->
    <el-drawer v-model="listenerFormModelVisible" append-to-body destroy-on-close :size="`${width}px`" title="执行监听器">
      <el-form ref="listenerFormRef" label-width="96px" :model="listenerForm">
      ...
      <p class="listener-filed__title">
        ...
        <x-button title="添加字段" type="primary" @click="openListenerFieldForm(null)" />
      </p>
      <el-table border :data="fieldsListOfListener" fit max-height="240" size="small" style="flex: none">
        ...
        <el-table-column label="操作" width="130px">
          <template #default="scope">
            ...
            <el-divider direction="vertical" />
            <el-button link size="small" style="color: #ff4d4f" @click="removeListenerField(scope.$index)">移除</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog v-model="listenerFieldFormModelVisible" append-to-body destroy-on-close title="字段配置" width="600px">
      <el-form ref="listenerFieldFormRef" label-width="96spx" :model="listenerFieldForm" style="height: 136px">
