<template>
  <div class="my-process-designer">
    <div class="my-process-designer__container">
      <div ref="bpmnCanvas" class="my-process-designer__canvas" style="height: 760px"></div>
    </div>
  </div>
</template>
...
const highlightDiagram = async () => {
  ...
  if (!isEmpty(removeTaskDefinitionKeyList)) {
    taskList.value = taskList.value.filter((item) => !removeTaskDefinitionKeyList.includes(item.definitionKey))
  }
}
