...
// 属性表单监听
export function usePropertyForm<T>(modelValue: T, emit: Fn): { formData: Ref<T> } {
...
export const PAGE_LIBS = [
  ...
  },
  {
    name: '营销组件',
    extended: true,
    components: ['PromotionCombination', 'PromotionSeckill', 'PromotionPoint', 'CouponCard', 'PromotionArticle'],
  },
