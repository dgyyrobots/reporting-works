  ...
  <component-container-property v-model="formData.style">
    <el-form label-width="80px" :model="formData">
      <el-card class="property-group" header="商品列表" shadow="never">
        <spu-showcase v-model="formData.spuIds" />
      </el-card>
      <el-card class="property-group" header="商品样式" shadow="never">
        ...
        <el-form-item label="商品简介" prop="fields.introduction.show">
          <div class="flex gap-8px">
            <color-input v-model="formData.fields.introduction.color" />
      ...
      <el-card class="property-group" header="按钮" shadow="never">
        ...
        <template v-if="formData.btnBuy.type === 'text'">
          ...
          <el-form-item label="左侧背景" prop="btnBuy.bgBeginColor">
            <color-input v-model="formData.btnBuy.bgBeginColor" />
          </el-form-item>
          <el-form-item label="右侧背景" prop="btnBuy.bgEndColor">
            <color-input v-model="formData.btnBuy.bgEndColor" />
          </el-form-item>
        </template>
        <template v-else>
          <el-form-item label="图片" prop="btnBuy.imgUrl">
            <upload-img v-model="formData.btnBuy.imgUrl" height="56px" width="56px">
