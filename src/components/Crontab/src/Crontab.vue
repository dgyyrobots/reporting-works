  ...
  <el-input v-model="defaultValue" class="input-with-select" v-bind="$attrs">
    <template #append>
      <el-select v-model="select" placeholder="生成器" style="width: 115px">
        ...
        <el-option v-for="(item, index) in shortcuts" :key="index" :label="item.text" :value="item.value" />
        <el-option label="自定义" value="custom" />
      </el-select>
    </template>
  </el-input>

  <el-dialog v-model="dialogVisible" append-to-body destroy-on-close title="cron规则生成器" :width="580">
    <div class="sc-cron">
      <el-tabs>
        <el-tab-pane>
          <template #label>
          ...
          <el-form>
            ...
            <el-form-item v-if="cronValue.second.type == '1'" label="范围">
              <el-input-number v-model="cronValue.second.range.start" controls-position="right" :max="59" :min="0" />
              <span style="padding: 0 15px">-</span>
              <el-input-number v-model="cronValue.second.range.end" controls-position="right" :max="59" :min="0" />
            </el-form-item>
            <el-form-item v-if="cronValue.second.type == '2'" label="间隔">
              <el-input-number v-model="cronValue.second.loop.start" controls-position="right" :max="59" :min="0" />
              秒开始，每
              <el-input-number v-model="cronValue.second.loop.end" controls-position="right" :max="59" :min="0" />
              秒执行一次
            </el-form-item>
        ...
        <el-tab-pane>
          ...
          <el-form>
            ...
            <el-form-item v-if="cronValue.minute.type == '1'" label="范围">
              <el-input-number v-model="cronValue.minute.range.start" controls-position="right" :max="59" :min="0" />
              <span style="padding: 0 15px">-</span>
              <el-input-number v-model="cronValue.minute.range.end" controls-position="right" :max="59" :min="0" />
            </el-form-item>
            <el-form-item v-if="cronValue.minute.type == '2'" label="间隔">
              <el-input-number v-model="cronValue.minute.loop.start" controls-position="right" :max="59" :min="0" />
              分钟开始，每
              <el-input-number v-model="cronValue.minute.loop.end" controls-position="right" :max="59" :min="0" />
              分钟执行一次
            </el-form-item>
        ...
        <el-tab-pane>
          ...
          <el-form>
            ...
            <el-form-item v-if="cronValue.hour.type == '1'" label="范围">
              <el-input-number v-model="cronValue.hour.range.start" controls-position="right" :max="23" :min="0" />
              <span style="padding: 0 15px">-</span>
              <el-input-number v-model="cronValue.hour.range.end" controls-position="right" :max="23" :min="0" />
            </el-form-item>
            <el-form-item v-if="cronValue.hour.type == '2'" label="间隔">
              <el-input-number v-model="cronValue.hour.loop.start" controls-position="right" :max="23" :min="0" />
              小时开始，每
              <el-input-number v-model="cronValue.hour.loop.end" controls-position="right" :max="23" :min="0" />
              小时执行一次
            </el-form-item>
        ...
        <el-tab-pane>
          ...
          <el-form>
            ...
            <el-form-item v-if="cronValue.day.type == '1'" label="范围">
              <el-input-number v-model="cronValue.day.range.start" controls-position="right" :max="31" :min="1" />
              <span style="padding: 0 15px">-</span>
              <el-input-number v-model="cronValue.day.range.end" controls-position="right" :max="31" :min="1" />
            </el-form-item>
            <el-form-item v-if="cronValue.day.type == '2'" label="间隔">
              <el-input-number v-model="cronValue.day.loop.start" controls-position="right" :max="31" :min="1" />
              号开始，每
              <el-input-number v-model="cronValue.day.loop.end" controls-position="right" :max="31" :min="1" />
              天执行一次
            </el-form-item>
        ...
        <el-tab-pane>
          ...
          <el-form>
            ...
            <el-form-item v-if="cronValue.month.type == '1'" label="范围">
              <el-input-number v-model="cronValue.month.range.start" controls-position="right" :max="12" :min="1" />
              <span style="padding: 0 15px">-</span>
              <el-input-number v-model="cronValue.month.range.end" controls-position="right" :max="12" :min="1" />
            </el-form-item>
            <el-form-item v-if="cronValue.month.type == '2'" label="间隔">
              <el-input-number v-model="cronValue.month.loop.start" controls-position="right" :max="12" :min="1" />
              月开始，每
              <el-input-number v-model="cronValue.month.loop.end" controls-position="right" :max="12" :min="1" />
              月执行一次
            </el-form-item>
          ...
          <el-form>
            <el-form>
              ...
              <el-form-item v-if="cronValue.week.type == '2'" label="间隔">
                第
                <el-input-number v-model="cronValue.week.loop.start" controls-position="right" :max="4" :min="1" />
                周的星期
        ...
        <el-tab-pane>
          ...
          <el-form>
            ...
            <el-form-item v-if="cronValue.year.type == '2'" label="间隔">
              ...
              年开始，每
              <el-input-number v-model="cronValue.year.loop.end" controls-position="right" :min="1" />
              年执行一次
            </el-form-item>
